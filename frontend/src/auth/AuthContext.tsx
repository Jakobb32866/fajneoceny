...
import { clearRecents } from '../api/recents';
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  async function signOut() {
    await clearToken();
    // Must happen on every sign-out: cached grades/settings and recents are
    // per-user, and the next account to sign in on this device would otherwise
    // see them.
    clearCache();
    clearRecents();
    setUser(null);
