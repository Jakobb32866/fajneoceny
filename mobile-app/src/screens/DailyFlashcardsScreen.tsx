  ...
  if (phase === 'empty') {
    return (
      <View style={styles.center}>
        ...
        {daily.nextDueAt && (
          <Text.BodySm style={styles.emptySubText}>Następna powtórka: {formatNextDue(daily.nextDueAt)}</Text.BodySm>
        )}
        {extraMessage ? (
      ...
      <View style={styles.center}>
        ...
        <View style={styles.doneActions}>
          ...
          <Button
            ...
            fullWidth
          />
          <Button title="Wróć" variant="ghost" disabled={fetchingBatch !== null} onPress={() => navigation.goBack()} fullWidth />
        </View>
      </View>
    );
  }
